<?php
// +------------------------------------------------------------------------+
// | 🔕 GROUPS: Вимкнення сповіщень для групи
// +------------------------------------------------------------------------+
        ...
        if ($group_id < 1) {
            ...
            if (mysqli_num_rows($group_query) == 0) {
                ...
                if ($member_data['count'] == 0) {
                    ...
                    // Установить is_muted = 1 для данного пользователя в группе
                    ...
                    if ($update_query) {
                        ...
                        // Логирование
                        error_log("🔕 Group {$group_id}: User {$user_id} muted notifications");
                    } else {
                        $error_code    = 10;
                        $error_message = 'Failed to mute group: ' . mysqli_error($sqlConnect);
