...
interface WorldMatesApi {
    ...
    @Multipart
    @POST("/xhr/upload_image.php?f=upload_image")
    ...
    @Multipart
    @POST("/xhr/upload_video.php?f=upload_video")
    ...
    @Multipart
    @POST("/xhr/upload_audio.php?f=upload_audio")
    ...
    @Multipart
    @POST("/xhr/upload_file.php?f=upload_file")
