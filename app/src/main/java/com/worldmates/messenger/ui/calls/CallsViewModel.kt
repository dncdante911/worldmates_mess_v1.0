...
class CallsViewModel(application: Application) : AndroidViewModel(application), SocketManager.SocketListener {
    ...
    override fun onCallAnswer(data: JsonObject) {
        try {
    ...
    override fun onIceCandidate(data: JsonObject) {
        try {
    ...
    override fun onCallEnded(data: JsonObject) {
        webRTCManager.close()
        callEnded.postValue(true)
        currentCallData = null
    }
...
EOF
cat /home/claude/CallsViewModel.kt
Output
