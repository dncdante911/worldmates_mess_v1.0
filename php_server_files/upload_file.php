<?php
/**
 * Standalone upload handler for encrypted file uploads from web version
 */
...
try {
    ...
    $new_filename = "encrypted_file_{$timestamp}_{$random}_{$safe_name}.{$extension}";

    $upload_base_dir = dirname(__DIR__) . '/upload/files';
    ...
    $relative_path = 'upload/files/' . $year_month . '/' . $new_filename;
