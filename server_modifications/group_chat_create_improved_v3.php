<?php
/**
 * СЕРВЕРНА МОДИФІКАЦІЯ v3: Додано ініціалізацію користувача
 *
 * ВИПРАВЛЕНО:
 * - Додано код для ініціалізації $wo['user'] з access_token
 * - Перевірка валідності токену
 * - Автоматична ініціалізація сесії користувача
 */
